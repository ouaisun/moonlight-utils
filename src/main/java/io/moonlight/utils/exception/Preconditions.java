...
import io.moonlight.utils.base.annotation.Nullable;
...
public final class Preconditions {
    ...
    public static void checkArgument(boolean expression, int code, Object errorMessage) {
        if (!expression) {
            throw new InvalidParameterException(code, String.valueOf(errorMessage));
        }
    }

    public static void checkArgument(boolean expression, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (!expression) {
            throw new InvalidParameterException(format(errorMessageTemplate, errorMessageArgs));
        }
    }

    public static void checkArgument(boolean expression, int code, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (!expression) {
            throw new InvalidParameterException(code, format(errorMessageTemplate, errorMessageArgs));
        }
    }
    ...
    public static void checkState(boolean expression, @Nullable Object errorMessage) {
        if (!expression) {
            throw new InvalidStatusException(String.valueOf(errorMessage));
        }
    }

    public static void checkState(boolean expression, int code, @Nullable Object errorMessage) {
        if (!expression) {
            throw new InvalidStatusException(code, String.valueOf(errorMessage));
        }
    }

    public static void checkState(boolean expression, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (!expression) {
            throw new InvalidStatusException(format(errorMessageTemplate, errorMessageArgs));
        }
    }

    public static void checkState(boolean expression, int code, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (!expression) {
            throw new InvalidStatusException(code, format(errorMessageTemplate, errorMessageArgs));
        }
    }
    ...
    public static <T> T checkNotNull(T reference, @Nullable Object errorMessage) {
        if (reference == null) {
            throw new NullException(String.valueOf(errorMessage));
        }
        return reference;
    }
    ...
    public static <T> T checkNotNull(T reference, int code, @Nullable Object errorMessage) {
        if (reference == null) {
            throw new NullException(code, String.valueOf(errorMessage));
        }
        return reference;
    }
    ...
    public static <T> T checkNotNull(T reference, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (reference == null) {
            ...
            throw new NullException(format(errorMessageTemplate, errorMessageArgs));
        }
        return reference;
    }

    public static <T> T checkNotNull(T reference, int code, @Nullable String errorMessageTemplate, @Nullable Object... errorMessageArgs) {
        if (reference == null) {
            // If either of these parameters is null, the right thing happens anyway
            throw new NullException(format(errorMessageTemplate, errorMessageArgs));
        }
