...
import io.moonlight.utils.base.Platforms;
import io.moonlight.utils.base.annotation.NotNull;
import io.moonlight.utils.base.annotation.Nullable;
import io.moonlight.utils.collection.type.primitive.IntObjectHashMap;
import io.moonlight.utils.collection.type.primitive.LongObjectHashMap;
import io.moonlight.utils.concurrent.jsr166e.ConcurrentHashMapV8;
...
public class MapUtil {
     ...
     */
    public static <K, V> V putIfAbsentWithFinalValue(@NotNull final ConcurrentMap<K,V> map, final K key, final V value) {
     ...
     */
    public static <K, V> V createIfAbsent(@NotNull final ConcurrentMap<K,V> map, final K key, @NotNull final ValueCreator<? extends V> creator) {
