...
public class ThreadPoolBuilder {
    ...
    public static class CachedThreadPoolBuilder {
        ...
        public ThreadPoolExecutor build() {
            ...
            return new ThreadPoolExecutor(minSize, maxSize, keepAliveSecs, TimeUnit.SECONDS, new SynchronousQueue<Runnable>(), threadFactory, rejectHandler);
        }
    }
    ...
    public static class QueuableCachedThreadPoolBuilder {
        ...
        public QueuableCachedThreadPool build() {
            ...
            return new QueuableCachedThreadPool(minSize, maxSize, keepAliveSecs, TimeUnit.SECONDS, new QueuableCachedThreadPool.ControllableQueue(queueSize), threadFactory, rejectHandler);
        }
    }
